...
export function DriverTripIdleView({ onRideHistory, onGoHub }: Props) {
  return (
    <AppScreen tab scroll eyebrow="Captain" title="Your trip" subtitle="No active ride">
      ...
      <Text style={styles.emptySub}>
        Stay online on the Hub tab to receive bike ride requests. Accepted trips appear here with
        navigation and fare details.
      </Text>
      ...
      <GlassCard style={styles.tipCard}>
        ...
        <View style={styles.tipBody}>
          ...
          <Text style={styles.tipText}>
            Turn Online ON and allow location so customers can book you. Ride offers pop up on Hub.
          </Text>
        </View>
      </GlassCard>

      <Button title="Ride history" onPress={onRideHistory} style={styles.historyBtn} />
